...
- **Advancement Ritual:** Let the development of at least one city move forward or backward by an era within three months, or stagnate for a hundred years without any change.
...
- **Attribute Gain:** **Inspiration** +1, **Dexterity** +1; your deceit and skill level up by one skill level. [[UNCLEAR: “deceit and skill” is ambiguous—this may mean two specific skills, or “deceit” plus skills generally.]]
...
Choose one of the following effects when you use **Time Authority**:
...
- **Time Stagnation:**
  ...
  - Until your next round of action, the target you selected or the affected object of the entire scene cannot take action; this does not include you.
  - You get an additional casting action on the basis of consuming one casting action; that is, this action does not count. [[UNCLEAR: “this action does not count” is unclear—whether it refunds the casting action immediately, or only negates the action cost for the round.]]
...
- **Reversal of Time:**
  ...
  - Also for reference, this ability is the reverse of time acceleration, and the effect of time acceleration can be restored through this ability. [[UNCLEAR: “restored” is ambiguous—this may mean “reversed/undone,” but the exact interaction is not precisely stated.]]

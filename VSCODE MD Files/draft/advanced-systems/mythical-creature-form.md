...
# Manifesting Mythical Creature Forms
...
> Lore: The following "Way/Pathway" examples describe what the manifested mythical creature form looks like and what it can do at specific Sequences.
...
- **Effect:** The Insect of Spirit can summon the most terrifying historical scene in memory.
- **Effect (terrain):** The terrain becomes inhospitable to any human beings and may be filled with lava, tsunamis, etc.
- **Effect (damage):** Creatures take 3d6 points of damage each round they remain in the area.
...
Reference list as provided:

- Fool 2, Apprentice 3, Error
- 4. Visionary path
- 5. Tyrant path
- 6. Sun path
- 7. Reader path
...
> GM Note: These rules are presented as "more complicated morphological rules" because the original author's rules are not perfect and some mythical creature forms are not yet provided.
...
### Core Stat Changes on Taking Mythical Creature Form

- **Effect:** Immediately multiply your base health and base spirituality by 2 times.
...
> GM Note: The RAW notes that using free actions this way against same-level opponents may leave you a "living target," and that you may pay a price to cover teammates.

### Usage Frequency, Rest, and Repeated Activations
...
**Definition:** Sequence 4-3 shows an incomplete mythical form. Only part of the whole person is in mythical form.

Examples (from RAW):

- Darkness Sequence 4 can become a huge eight-legged wolf, but the face is still a human face, and a small part of the body still looks human.
- The Viewer channel may become a dragon lady.
- God of War will become a giant but will not completely lose its previous appearance.
- The Reader will not become a tower of books but a bookshelf.
...
If facing enemies two sizes smaller than yourself:

- **Effect:** Damage increases by an additional 1d6.
- **Effect:** The distance of melee attacks is doubled.

If facing enemies two sizes larger than yourself:

- **Effect:** Skill identification +5; skills are easier to hit.

If only one size difference:

- **Effect:** Advantage damage is 1d3.
...
3. Medium-sized creatures (humans, murlocs, young lions or tigers).
4. Medium to large size creatures (adult lions, tigers, bears, cattle).
5. Large-scale creatures (giants, large-scale Extraordinary creatures, Feysacs, God of War Path Extraordinary).
6. Super-large creatures (the size is comparable to a ship, a 4-meter or 6-meter giant, a creature that can only cause the destruction of a ship).
...
> GM Note: The RAW labels these as "unofficial mythic creature forms" with rules.
...
- Dark, corrupted, and undead creatures around the Golden Crow suffer 1d6 holy or fire damage each round due to blazing sunlight; weak undead are dispelled directly.
- The environmental damage from sunlight may be strengthened by the fire of light.
- Any existence that looks directly at the Golden Crow and has no defense methods is regarded as blind.
- The Golden Crow emits endless rays of light; to others it appears as a huge sun (radiance) in the center.
- Non-demigod-level enemies who forcibly break through this radiance may be burned when approaching and immediately suffer the Golden Crow's environmental damage.
...
- Your movement effect can drag out afterimages in performance (high-speed movement), but it cannot be faster than lightning.
...
- You are considered a very large creature.
- Normal means cannot cause you to be blown, levitated, or physically forced to move.
- You gain an additional +10 hit points.
- Plus 1d6 damage against medium-sized creatures.
- Attack distance is doubled.
- When attacked by a medium-sized creature, the medium-sized creature's attack identification +5.
...
If you are a demigod who has not yet reached Sequence 2 (Sequence 4-3):

- Consider your mythical creature form as appropriate, because turning it on likely means you are about to lose control.
- You immediately suffer the sanity strike suffered when the Sequence level is promoted and gain the corresponding sanity strike bonus.
...
- The Audience Path and the Fate Path can accumulate good luck through hypnosis and psychological suggestion respectively.
...
The specific image of the mythical creature form converts according to the strength of current Extraordinary characteristics (explained as considering transfer paths).

- Example (from RAW): If you are a reader of Sequence 5 and switched to the spectator path at Sequence 4, your form becomes a hybrid with spectator as main and reader as secondary; Sequence 4 suppresses Sequence 5.
- If you later jump back to reader or go to other paths, further mixing is likely.

Beliefs can change the mythical creature form to a certain extent.

- Example (from RAW): If you believe in the Evernight Goddess and switch to a Beyonder, the form may still be dominated by a magic wolf.
- This is decided by the Extraordinary through consultation with the GM.

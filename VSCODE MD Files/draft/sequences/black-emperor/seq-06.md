...
3. **Distorted Intentions:** You distort intentions existing in other people’s minds into similar meanings (for example, distorting the intention of intercepting separately into separate actions). The distorted intentions will be gone forever, which will disappear after 1 minute perceived something wrong.
   [[UNCLEAR: Distorted intentions are described as both “gone forever” and “disappear after 1 minute,” and the exact duration/end condition cannot be resolved.]]
...
- **Distorted Language:** It can produce effects, but at the moment of production, the target can use a successful [[Spiritual Intuition]] identification to detect the change of the rules and roughly realize which rules are wrong, and the owner of the words can use normal identification to get rid of it. Non-Will check breaks the rules.
  [[UNCLEAR: This multi-target removal/detection text conflicts with the earlier “To get rid of the distortion effect” procedure for Distorted Language, and the correct resolution cannot be determined.]]
- **Distorted Behavior:** Distorted behavior can only be in effect for 1 round instead of 1.
  [[UNCLEAR: “instead of 1” is incomplete in the source, so the intended comparison (round/minute/other) cannot be resolved.]]
...
- **Corruption:** The effect on faces higher than 1 character is equal to warp channeling.
  [[UNCLEAR: This line uses “Corruption” (not “Corrosion”) and an unclear phrase (“faces higher than 1 character”); “warp channeling” is also undefined here, so the exact intended rule cannot be resolved.]]

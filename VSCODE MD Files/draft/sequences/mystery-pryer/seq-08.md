---
title: "Sequence 8: Melee Scholar"
id: "myster-pryer-seq-08"
tags: ["pathway:myster-pryer", "sequence:8"]
---

# Scholar Pathway: Sequence 8
...
2. **Feint and close-range firearm substitution:**
   ...
   - When using a firearm, if the target is less than 5 meters away from you, shooting can be changed to fighting identification, but the related attribute is Agility.
...
- **Effect (mechanics):**
  - Use Inspiration instead of Strength to make a **combat check** against the target’s **physical defense**.
  - Use Inspiration instead of Strength to gain a Strength damage bonus.
...
- **Effect (mechanics):**
  - You gain a movement bonus equal to your Inspiration divided by 2.

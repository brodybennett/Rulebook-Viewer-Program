...
- **Advancement Ritual:** Requires a Demigod Mummy.
...
- **Use:**
  - Use a **free action** to transform into an extremely delicate humanoid puppet.
  - Use a **spellcasting action** to create a dispellable curse relationship with a target.
  - Turning off the damage-sharing aspect is an unlimited number of **free actions**; turning it on is also a **free action** (does not affect an already-established bond).
- **Effect:**
...
- **Limits:**
  - Two ways to meet the curse condition:
    ...
    - A kind of flesh and blood is consumed after being used.
  - Any armor and damage reduction other than the target’s body itself are ignored for the doubled body-to-body sharing effect; you can turn off damage sharing in time.
- **Duration:**
...
- **Aftereffects / Ongoing sharing rules:**
  ...
  - The connection does not change the restraint relationship between you:
    - Even if a fallen creature (as a puppet) turns into an undead creature, the additional restraint it receives is still fallen-creature biological damage.

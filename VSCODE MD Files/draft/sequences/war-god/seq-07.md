...
- **Diagonal Slash:** You quickly cut the target obliquely in two.
  - **Use:** 1 **Attack Action**
  - **Effect:** Apply a -2 penalty to the enemy's Physical Defense (including Agility (DEX) and Dodge as normal).
...
1) **Master Level:** When using a weapon, no matter whether your corresponding skill meets the requirements or not, the skill is considered a master.

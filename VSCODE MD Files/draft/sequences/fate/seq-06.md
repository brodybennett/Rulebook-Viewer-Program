...
- **List of disasters** (passive disasters only affect you alone):
  - **Restricted actions:**
    - All creatures within 20 meters need to make a **Luck** test (**DV 20**), otherwise they will lose their balance.
    - They can change to a **DV 30 Agility** test to react forcefully.
  ...
  - **Chaos out of control:**
    ...
    - ① Creatures in the area need to make a **Luck** identification (**DV 20**), otherwise they will suffer **1d6** physical damage due to chaos.
  ...
  - **Action failure:**
    - For all creatures within 20 meters, any spellcasting/attack action requires a **Luck** check (**DV 20**), otherwise it will fail.
  ...
  - **Omen magnification:**
    ...
    - When a big failure occurs, the resulting result can be avoided with **Luck (DV 20)**.
  ...
  - **Difficulty in action:**
    - For all creatures within 20 meters, normal behavior that does not require identification also requires a **Luck** identification (**DV 20**) to perform.

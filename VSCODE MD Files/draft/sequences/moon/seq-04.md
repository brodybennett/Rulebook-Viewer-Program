...
# Sequence 4: Shamen King (Blood Count)

## Shamen King (Blood Count)
...
- **Limits:**
  ...
  - If your moon knowledge level is a Master, you can carry up to 5 moon paper figurines at the same time, and only 1 for training. [[UNCLEAR: The restriction “only 1 for training” is not defined (what training is, and how it limits carrying/using figurines).]]
  - **Area damage and multiple Stand-ins:** [[Area Damage]]
    - In addition to being consumed multiple times by the Stand-in described separately, when suffering range damage, at least two Stand-ins must be consumed to completely avoid the damage; consuming only one Stand-in causes you to suffer half the damage. [[UNCLEAR: “Consumed multiple times by the Stand-in described separately” references rules not present in this section.]]
...
> **GM Note:** The paper figurines of the Fool’s Path are ordinary paper figurines in essence, so they can only be used by extraordinary people of the Fool with extraordinary abilities and are not considered extraordinary items. [[Fool Pathway]] [[Extraordinary Item]]
>
...
- **Effect:**
  ...
  - Mysteriously attack the opponent’s [[Will Defense]]; then the target establishes contact with you, which is regarded as entering a **Substitute State**. [[Substitute State]]
...
- **In the Substitute State (called “avatar state” in the RAW):** [[UNCLEAR: The RAW uses both “substitute state” and “avatar state” without explicitly stating they are the same state.]]
  - **Obscuration**
    - **Use:** Free action; continued obscuration costs you an action each turn.
    - **Effect:** The target blocked by you is regarded as blind from the perspective of both the enemy and the enemy. Unless there are other means to distinguish position, the enemy and the enemy continue to be disadvantaged. [[Blind]] [[UNCLEAR: The phrase “both the enemy and the enemy” is duplicative/self-contradictory and the intended affected sides are unclear.]]
  - **Crushing**
    ...
    - **Effect (foe):** Your foe immediately suffers: “Your damage” +4d6+5 **Hard Damage** (ignores any normal means of armor, doubles, and damage reduction). [[Hard Damage]] [[Armor]] [[Doubles]] [[Damage Reduction]] [[UNCLEAR: “Your damage” is not defined (what base value it refers to) and may depend on rules outside this section.]]
...
- **Effect:**
  ...
  - Each bat has 1 hit point equal to your current hit points. [[Hit Points]] [[UNCLEAR: “Each bat has 1 hit point equal to your current hit points” is internally inconsistent and may rely on missing swarm rules.]]
  - Your movement speed is multiplied by 2. [[Movement Speed]]
  - In this state, unless all bats are killed, you can regroup; this state cannot be hit hard. [[UNCLEAR: “Cannot be hit hard” is undefined (likely refers to Hard Damage or a specific rules term).]]

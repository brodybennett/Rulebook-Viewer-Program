...
- **Limits:** The number of magic potions a Potions Professor can make is three times the reputation level. [[Reputation Level]]
...
- **Note:** There may be conflicts between different types of potions that bring bad effects, so you need to try to control the type and quantity of potions you take each time.
- **Limit:** The number of magic potions that are effective at the same time cannot exceed your physical fitness value. [[Physical Fitness Value]]
...
4. **Defense Elixir**
   - **Effect:** Gain 4 points of armor.
   - **Duration:** 1 hour.
   - **Limits:** This effect cannot be superimposed with other armor. [[Armor]]

5. **Potion of Destruction**
   - **Use:** Throw it against physical defenses.
   - **Effect:** Produces a large amount of black flames, causing 2d6 curses, 2d6 poisons, and 2d6 fire damage to an area with a radius of 3 meters. [[Curse Damage]] [[Poison Damage]] [[Fire Damage]]
   - **Targeting and range:** Area, radius 3 meters.
   - **Effect:** If you drink it directly, the damage is doubled.

6. **Fire Dragon’s Breath**
   - **Use:** After drinking the potion, one quick action, only once, can’t be superimposed. [[Quick Action]]
   - **Effect:** You can spew out a hot wave of red flames from your mouth; Mysticism against physical defense, success will cause 4d6 flames to 1 target harm. [[Mysticism]] [[Physical Defense]]
   - **Aftereffects:** After taking the dragon’s breath, the user will not be able to speak until the flame is released.
...
9. **Odorless Perfume**
   - **Use:** Spray or sprinkle all over the body.
   - **Effect:** Causes an area or a creature to not produce any smell; identification related to smell will automatically fail. [[Smell-Based Identification]]

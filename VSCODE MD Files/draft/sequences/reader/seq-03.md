...
- **Appraisal Results (by Difficulty):**
  ...
  - **Difficulty 30:** In addition to the above, learn what the target is best at and least good at; immediately know the target’s top 3 skills, the highest skill level, and which skill is at the lowest level (“lowest level 1” is referenced).  
    ...
    [[UNCLEAR: “lowest level 1” is unclear (always level 1 vs. example/typo).]]
...
- **Success/Failure Extremes:**
  - **Big Success:** Based on your Success Level, you gain the detailed part of any information you could have obtained (e.g., complete skill list and levels; whether the target has changed Pathway and what it was; or the complete 6 attribute values).  
    Targets understood by Difficulty 45 or Big Success “continue to gain an advantage” for the person who understands them.  
    [[UNCLEAR: “gain an advantage” is not defined (type/bonus/duration not specified).]]

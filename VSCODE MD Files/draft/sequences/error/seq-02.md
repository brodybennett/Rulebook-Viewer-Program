...
- **Use:** A casting action that attacks the opponent’s **Physical Defense** “with skillful hands.”  
  [[UNCLEAR: The RAW does not specify the exact test/roll used to resolve this attack beyond “attack Physical Defense.”]]
...
- **Duration:** 2 hours.
- **Detection:**  
  - The same person can pass an **Inspiration** appraisal (**Difficulty Value** 15) to detect the sense of disobedience.  
  - A target who is one **Sequence** lower than you can pass an **Inspiration** appraisal (**Difficulty Value** 20) to perceive the sense of incongruity.  
  [[UNCLEAR: The RAW is unclear about who makes each appraisal (observer vs. the target) and what “the same person” refers to.]]
...
- **Notes:** “Now, it is no longer limited to the wrong way.”  
  [[UNCLEAR: The RAW references “the wrong way” without defining what the previous limitation was in this section.]]
...
- Stealing fate and turning others into clones are not the same:
  - Stealing a person’s fate does not turn them into a doppelgänger; it turns them into an unlucky person who still exists, but no one notices what they do.
...
- **Effect:** You detach a Worm of Time, which parasitizes targets through shadows that are hard to see.
  ...
  - At that time, conduct a skill test against the target’s **Will Defense**; on success, it is considered to have entered a shallow parasitic state.
...
- **Effect (check):** Pass a Library or **Inspiration** check of **Difficulty Value** (30 - the target’s sequence level).

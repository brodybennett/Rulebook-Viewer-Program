...
- **Targeting and range:** Choose 1 **target** within 50 meters
  - At [[LINK LATER: Sequence 5 | type=sequence | hint=previous sequence in same Pathway as Prometheus]], stealing range increases to 100 meters.
...
- ① The Fire Thief can use the stolen ability freely for 10 minutes. After 10 minutes, the ability will disappear. It must be 12 hours before the same target can be stolen again, and the original extraordinary ability skill appraisal will be replaced by the skill appraisal. [[UNCLEAR: The final clause about “skill appraisal” replacing another appraisal is not mechanically specific enough to restate confidently.]]
...
- ⑤ When stealing does not achieve the desired result and needs to obtain abilities randomly, perform 1dX where X is the number of Sequence levels of the stolen person. Then check the number of abilities that can be stolen in the corresponding Sequence according to the Sequence level obtained by the die, and then perform random. [[UNCLEAR: “1d ‘number of sequence levels’” and the follow-up selection procedure are not fully defined in the RAW.]]
...
- ④ Know the weakness and important things of the target (if the weaknesses and important things in the past are not now, it is beneficial to change to +1). [[UNCLEAR: It is unclear whether this changes the bonus for this condition only, or modifies the total bonus in some other way.]]

#### Special Stealing Cases

- ① Manipulating the thread of the spiritual body: the [[LINK LATER: Master of Puppet | type=pathway | hint=puppetry-related Pathway or role]] can no longer continue to be marionetted, but it does not affect them maintaining the progress of manipulating the existing thread of the spiritual body, and manipulating the puppet that has become their secret puppet; but the Fire Thief’s secret puppet will die after being unable to use abilities. [[UNCLEAR: “Secret puppet” interactions and what exactly becomes unusable are not fully specified.]]
- ② [[LINK LATER: Herding | type=mechanic | hint=ability or mechanic named “Herding”]]: The Fire Thief can herd while holding the ability, but after the ability maintenance time is over, if the Fire Thief does not take the initiative to expel the characteristic of grazing, it will immediately lead to a promotion appraisal, and may become an extraordinary person of the jump path. [[UNCLEAR: “promotion appraisal” and “jump path” are referenced but not defined here.]]
- ③ [[LINK LATER: Records | type=mechanic | hint=recording/recorder ability]]: Stealing records will only make the recording officer unable to continue recording the ability, and will not affect the recording officer’s ability to release the recorded ability. If the ability in the record is higher than 1 character, it will suffer from [[LINK LATER: Extra: Suppression of Personality | type=rule | hint=special effect triggered during stealing]] when stealing.  
...
- ④ [[LINK LATER: Simulation | type=mechanic | hint=polymath simulation/interpreting abilities]]: Stealing the simulation will only prevent the polymath from simulating the abilities that have not been mastered, and will not affect the capabilities that the polymath has mastered. [[UNCLEAR: The RAW contains an “analyze” fragment here with no clear mechanical meaning.]]  
...
- ⑤ Transformation ability: You can only steal one of the transformation abilities at a time. For example, you can steal the resentment, but the resentment still retains resentment scream and other abilities; demonization steals part of the demon traits (“semi-demonization”). [[UNCLEAR: “Resentment,” “resentment scream,” and “demonization” are referenced as established abilities/traits but not defined here.]]
- ⑥ [[LINK LATER: Flesh Magic | type=mechanic | hint=permanent bodily change ability]] / [[LINK LATER: Faceless Man | type=sequence | hint=identity/face-changing sequence]]: If flesh magic or transformation can produce permanent physical changes, even if the ability maintenance time disappears, the changes brought about can still be maintained; but the growth and aging of the human body will still affect follow-up.
- ⑦ Strengthening/Buffing/Additional Effects: For example, the sacred contract of the [[LINK LATER: Sun Path | type=pathway | hint=Pathway associated with “sacred contract”]]. This kind of strengthening, or an ability that has been used, can continue to be retained until the time when the ability takes effect is exceeded, even if the maintenance time of your stolen ability has disappeared.
...
- **Effect:**
  ...
  - ⑤ Even if you can see these light clusters, you will not be able to know the corresponding meanings and extraordinary abilities of these light clusters until you thoroughly understand the target. Identify it. [[UNCLEAR: The final “Identify it” directive is unclear on whether it is a separate check or a prerequisite statement.]]
- **Limits:**

...
- See also: [[LINK LATER: Abyss Pathway | type=pathway]]

> **Lore:** Also known as the “demon” Pathway, corresponding to the Tarot card “demon”. [[LINK LATER: Tarot Card — Demon | type=term | hint=tarot correspondence]]
...
- In addition, your fighting-related, weapon-use-related, throwing, and criminal skills can quickly grow to proficiency:
  ...
  2. For details about criminal skills, see the same criminal skills of different Sequence 9. [[LINK LATER: Criminal Skills (Sequence 9) | type=table | hint=shared Sequence 9 skill list]]
...
- When creating a character that has not just been promoted, you can use the relevant attributes brought by the potion as inspiration to add points for growth skills.
  ...
  - The Inspiration attribute itself can add points to any skills.

### Spirit Vision

- You gain **Spirit Vision** through your Inspiration.
- **Use:** 1 **Free Action**.
- **Cost:** 1 [[LINK LATER: Spirituality Point | type=term | hint=resource point]] per round.
- **Effect:** While Spirit Vision is active, your vision gains the following benefits:
  ...
  5. When in the state of Spirit Vision, your [[LINK LATER: Spiritual Intuition Test | type=mechanic]] gains **+1 beneficial**.
...
- Notes:
  ...
  - Unlike dead creatures, undead creatures have deep black spirituality color instead of no color. [[LINK LATER: Undead | type=condition | hint=creature state]]
...
- **Fall** is defined as fallen creatures or anyone who has violated public morals, no matter what they are for difficulties. [[LINK LATER: Difficulty Value | type=term | hint=DV]]
- **Limits:** (Fallen Perception is a supplementary description to Spirit Vision, which cannot be recorded or stolen.)

> **Lore:** Example: There are actually a full one-sixth of the women in Backlund, the capital of Loen, who have worked as street girls, and there are also current female teachers among them. They are all forced to survive, and they have no choice but to do so in order to survive, but they are still considered depraved. [[LINK LATER: Backlund | type=location]] [[LINK LATER: Loen | type=location | hint=country]]
>
> **Lore:** People from other countries will find that in such a conservative country as Ruen, the capital is full of street girls, and they all meet the requirements of the Sequence 5 ceremony of the abyss pathway. [[LINK LATER: Ruen | type=location | hint=country]] [[LINK LATER: Abyss Pathway Sequence 5 Ceremony | type=ritual | hint=Sequence 5 promotion ceremony]]

### Intoxicated

- You are addicted to the thrill of crime.
- **Trigger:** Whenever you complete a criminal action.
- **Effect:** You restore a certain amount of [[LINK LATER: Sanity | type=term | hint=mental resource]] according to the degree of the crime:
...
- **Limits:**
  - Sanity points can exceed the upper limit, up to twice your sanity value.
  - Every 3 days (72 hours), the sanity beyond the upper limit will lose 1 point.
  - The sanity consumed beyond the upper limit will not be included in the value leading to madness. [[LINK LATER: Madness | type=condition | hint=sanity breakdown]]

- **Special:** When dealing with the sanity loss of the [[LINK LATER: Sequence 5 Promotion Ceremony | type=ritual | hint=advancement ceremony]], only the second level of crime is valid, and the third level of crime is invalid.
